    ...
    <v-row justify="center" class="space px-16 pb-5">
        <v-col cols="12" xs="12" sm="6" md="4" v-for="(pack , i) in packs" :key="i">
            <v-card class="mx-auto rounded-xl" max-width="300" flat outlined>
                ...
                <v-card-title class="grey--text-grey-darken-1 caption mt-n6">{{ pack.subtitle }}</v-card-title>
...
export default {
    data: () => ({
        bpm: 1,
        packs: [
            { img: "p1.png", title: "Medium Box", subtitle: "Tomate, Cabbage, oil, Cauliflower", price: "$55" },
            { img: "p2.png", title: "Big Pack", subtitle: "Tomate, Cabbage, oil, Cauliflower", price: "$55" },
            { img: "p3.png", title: "Small", subtitle: "Tomate, Cabbage, oil, Cauliflower", price: "$55" },
            { img: "p4.png", title: "Medium Box", subtitle: "Tomate, Cabbage, oil, Cauliflower", price: "$55" },
            { img: "p5.png", title: "Medium Box", subtitle: "Tomate, Cabbage, oil, Cauliflower", price: "$55" },
            { img: "p6.png", title: "Medium Box", subtitle: "Tomate, Cabbage, oil, Cauliflower", price: "$55" },
        ],
    }),
    methods: {
        decrement () {
