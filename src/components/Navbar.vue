...
<v-app-bar app color="white" flat>
    <v-badge color="#DSF0DB" dot>
        <v-img src="1.png" contain width="30"></v-img>
</v-badge>
<v-toolbar-title class="m1-4">
...
<v-avatar color="#FFF0EE" size="40">
 ...
 <span class="grey--text d-none d-sm-flex">Hello, <strong>Jhonny</strong></span>
 <v-avatar size="30" class="m1-2">
