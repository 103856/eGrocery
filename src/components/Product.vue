    ...
    <v-row justify="center" class="space px-16">
        <v-col cols="12" sm="6" md="4" v-for="(product, i) in products" :key="i">
            <v-card class="mx-auto rounded-xl" max-width="300" flat outlined>
                ...
                <v-card-title class="grey--text-grey-darken-1 caption mt-n6">{{ product.subtitle }}</v-card-title>
...
export default {
  data: () => ({
    bpm: 1,
    products: [
      { img: "pr1.png", title: "Cabbage", subtitle: "1kl", price: "$13" },
      {
        img: "pr2.png",
      ...
      { img: "pr3.png", title: "Potato", subtitle: "1kl", price: "$17" },
      {
        img: "pr4.png",
        title: "Bundle Pack",
      ...
      { img: "pr6.png", title: "Papaya", subtitle: "1kl", price: "$10" },
    ],
  }),
  methods: {
    decrement(){
