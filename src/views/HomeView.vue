<template>
  <v-app>
    ...
    <v-container fluid>
      <v-row>
        <v-col cols="12">
          <v-card class="mx-auto rounded-x1" flat>
              ...
              <v-col cols="12" xs="12" sm="6" md="7">
                ...
                <p>
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. <br>
                   odio enim odit facilis repellat, temporibus sint itaque maiores  <br>
                   quia nulla, similique velit voluptas dicta ipsam delectus  <br>
                   excepturi optio! Aliquam, sapiente!
                </p>
...
import Pack from "/src/components/Pack.vue";
